...
export function register(config) {
  ...
  //   // `file:` should be ignored for some none-browser environment, such as
  //   `Electron`. return;
  // }
  ...
  if (process.env.NODE_ENV === "production" && "serviceWorker" in navigator) {
    ...
    // We are not waiting for window's load event as it was for the
    // create-react-app template because we register a service worker in the
    // React app that runs after window loaded and the load event already was
    // emitted.
