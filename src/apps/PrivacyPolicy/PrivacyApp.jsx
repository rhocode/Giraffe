    ...
    <React.Fragment>
      ...
      <Container maxWidth="lg" component="main" className={classes.heroContent}>
        ...
        <Typography variant="" align="left" color="textSecondary" component="p">
          ...
          <p>
            Alexander Fu and the SatisGraphtory maintainers may update our
            Privacy Policy from time to time. Thus, you are advised to review
          ...
          <p>
            Alexander Fu built the SatisGraphtory app as an Open Source app.
            This service is provided by Alexander Fu at no cost and is intended
            for use as is.
          </p>
          <p>
          ...
          <p>
            ...
            not collected by Alexander Fu and the SatisGraphtory Alexander Fu
            and SatisGraphtory maintainers in any way.
          </p>
          <p>
          ...
          <p>
            ...
            collect, monitor and analyze this type of information in order
            forecast user trends and expected costs for maintaining the service.
            These third party service providers have their own privacy policies
            addressing how they use such information. If you would like to
            opt-out from this tracking, we encourage you to do so here at{' '}
            <a
          ...
          <p>
            ...
            external sites are not operated by Alexander Fu and the
            SatisGraphtory maintainers. Therefore, we strongly advise you to
          ...
          <p>
            ...
            us with personal information, please contact Alexander Fu or the
          ...
          <p>
            ...
            do not hesitate to contact Alexander Fu or the SatisGraphtory
            maintainers at satisgraphtory@rhocode.com.
          </p>
        </Typography>
      </Container>
