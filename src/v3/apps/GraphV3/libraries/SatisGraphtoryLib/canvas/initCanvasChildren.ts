...
const initCanvasChildren = (
  ...
  if (urlParams.get('useBlank')) {
    ...
    data = {
      d:
        'CgBgCGAACIADAUlIBgAHBwAuASIAoAgAsSAccgEgB2bAFUjADhNcAwAUAC2Bh7AOQCUAQAEEABgCMAtAAJC6SAFkAzwAC2ASQDJAVkgAZAIcAhgGkACgEi9BAUIAcggGUAE/AAqAhQAEAgCt4AtQAPACsqAOgAzgD8AEKaAFXOALAA8QDMAH6QAIwA19oAowD7AEUAJJAA2Y7oACEAmQApKgBokqVqKoIAygC5KgDwAJVQkEA===',
      c: 0,
      v: '0.1.0',
    };
  }
